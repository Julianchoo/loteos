...
Estamos armando una pagina web para que los usuarios puedan gestionar sus lotes de adquisiciones. Nuestra empresa se llama "Fitzroya Desarrollos", y vamos a tener una home presentando brevemente nuestra empresa y luego tabs para cada proyecto. Por lo pronto tenemos un solo proyecto llamado "San Matías Arroyo de La Cruz", que es un barrio chico, de 9 hectáreas, en el centro de Arroyo de la Cruz, municipio de Exaltación de la Cruz, sobre la Ruta 192.
