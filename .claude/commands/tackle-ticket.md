...
This command finds a given ticket id in a google sheet base of tickets, prepares an action plan to tackle this ticket, asks approval from the user, and proceeds to tackle the ticket.
...
Envs file has the airtable token
