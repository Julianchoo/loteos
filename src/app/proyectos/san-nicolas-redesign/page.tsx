...
export const metadata: Metadata = {
  title: "Preview San Nicolás - Rediseño | Fitzroya",
  description:
    "Preview no indexable del rediseño de la página San Nicolás en Guernica.",
  robots: {
    index: false,
    follow: false,
  },
...
export default async function SanNicolasRedesignPage() {
